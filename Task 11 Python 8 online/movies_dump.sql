...
CREATE TABLE public.actors (
    id integer NOT NULL,
    actors character varying(200) DEFAULT 'noname'::character varying NOT NULL
);
...
CREATE TABLE public.directors (
    id integer NOT NULL,
    directors character varying(100) DEFAULT 'unknown'::character varying NOT NULL
);
...
CREATE TABLE public.movies (
    ...
    actor_id integer DEFAULT 0 NOT NULL,
    genres character varying(100) DEFAULT 'unknown'::character varying NOT NULL,
...
COPY public.actors (id, actors) FROM stdin;
1	Ryan Gosling
2	TimothҐe Chalamet
3	Amy Adams
...
COPY public.directors (id, directors) FROM stdin;
1	Denis Villeneuve
2	Christopher Nolan
3	James Cameron
\.
...
COPY public.movies (id, title, director_id, actor_id, genres, year) FROM stdin;
1	Blade Runner 2049	1	1	sf	2017
2	Dune	1	2	sf	2021
3	Arrival	1	3	drama	2016
4	Interstellar	2	4	sf	2014
5	Inception	2	5	action	2010
6	The Dark Knight	2	6	action	2008
7	Avatar	3	7	adventure	2009
8	Terminator 2: Judgment Day	3	8	action	1991
\.
